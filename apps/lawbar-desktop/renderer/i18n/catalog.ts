...
export const CATALOG = {
  ...
  // WI-10 evidence items (R2): create from a registered document, adopt / exclude.
  "evidence.showEvidence": "证据",
  "evidence.loading": "正在加载证据…",
  "evidence.load.failed": "无法加载证据列表，请重试。",
  "evidence.empty": "尚无证据。",
  "evidence.emptyHint": "从已登记的文书中添加证据；只有已采纳的证据会进入证据目录。",
  "evidence.add.document": "来源文书",
  "evidence.add.documentPlaceholder": "选择已登记的文书",
  "evidence.add.noDocuments": "本案尚未登记任何文书，无法添加证据。",
  "evidence.add.title": "证据名称",
  "evidence.add.proof": "证明内容",
  "evidence.add.pages": "页码",
  "evidence.add.side": "提交方",
  "evidence.side.unset": "未定",
  "evidence.side.our": "我方",
  "evidence.side.opposing": "对方",
  "evidence.add.submit": "添加证据",
  "evidence.adding": "正在添加…",
  "evidence.added": "已添加，待采纳。",
  "evidence.error.documentRequired": "请选择来源文书。",
  "evidence.error.titleRequired": "请填写证据名称。",
  "evidence.error.addFailed": "无法添加证据，请重试。",
  "evidence.error.updateFailed": "无法更新证据，请重试。",
  "evidence.status.proposed": "待采纳",
  "evidence.status.accepted": "已采纳",
  "evidence.status.rejected": "已排除",
  "evidence.status.superseded": "已被替代",
  "evidence.action.adopt": "采纳",
  "evidence.action.exclude": "排除",
  "evidence.saving": "正在保存…",
  "evidence.saved": "已保存。",
  "evidence.pagesPrefix": "页码：{pages}",
  "evidence.proofPrefix": "证明内容：{proof}",
