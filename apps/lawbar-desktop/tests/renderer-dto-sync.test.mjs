...
const PAIRS = [
  ...
  // matter-details-edit Phase C: the renderer update-details bridge mirrors the
  // canonical UPDATE_MATTER_DETAILS_DTO_FIELDS (top-level) + the patch field set
  // UPDATE_MATTER_DETAILS_PATCH_FIELDS in src/caseBox/dto/matter.ts.
  ["RENDERER_UPDATE_MATTER_DETAILS_DTO_FIELDS", "UPDATE_MATTER_DETAILS_DTO_FIELDS"],
  ["RENDERER_UPDATE_MATTER_DETAILS_PATCH_FIELDS", "UPDATE_MATTER_DETAILS_PATCH_FIELDS"],
