...
// WI-805: the case-box entity IPC tests (listDeadlines / listFacts / docket
// create+confirm / fact create) moved to tests/ipc-casebox-handlers.unit.test.mjs;
// their handler imports were pruned here. CHANNEL + CaseBoxPersistenceError stay
// (the channel-names + archiveMatter illegal_transition tests still use them).
