...
// It imports NO PDFKit, computes NO geometry, creates NO A0.7 marker, and has NO product behavior.
// Its only job is to prove the SwiftPM toolchain (and macOS CI) can build + test this package.
