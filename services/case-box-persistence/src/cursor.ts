...
export function decodeCursor(
  ...
  } else if (p.kind === "facts_by_matter") {
    if (
      p.last_sort_tuple.length !== 2 ||
      typeof p.last_sort_tuple[0] !== "string" ||
      typeof p.last_sort_tuple[1] !== "string"
      ...
      throw new CaseBoxPersistenceError(
        "invalid_argument",
        `malformed cursor: facts_by_matter requires last_sort_tuple [created_at:string, id:string]`,
      );
    }
  } else if (p.kind === "docket_entries_by_matter") {
    if (
      p.last_sort_tuple.length !== 2 ||
      typeof p.last_sort_tuple[0] !== "string" ||
      typeof p.last_sort_tuple[1] !== "string"
  ...
  } else if (p.kind === "ocr_links_by_matter") {
    if (
      p.last_sort_tuple.length !== 2 ||
      typeof p.last_sort_tuple[0] !== "string" ||
      typeof p.last_sort_tuple[1] !== "string"
