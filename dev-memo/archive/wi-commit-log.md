...
2026-06-13T14:34:06Z override consumed: BATCH-FAIL remediation, single-use override: batch-guard is audit-DUE (4 commits since marker 3011afa) and the Layer-B audit of 3011afa..dd1faf5 returned BATCH-FAIL C0 H0 M2 L0 (M1 ordinal column = fabricated data; M2 stale packaged UI tests). Both Mediums fixed (序号 column removed; smoke.packaged + casebox-ui refreshed to 案件台账 / 仅保存在本机); full default gate 584/584. Authorizes ONE combined fix commit; marker stays 3011afa; the post-fix Layer-B audit must cover 3011afa..fix-head; no push/merge/marker mutation via this override.
2026-06-13T17:40:00Z override consumed: BATCH-FAIL remediation, single-use override: Layer-B audit of 3126b24..e0fdbea returned BATCH-FAIL C0 H0 M1 L1. M1 is a real anti-drift scanner gap: hardcoded visible `.textContent = "literal"` assignments are not detected. L1 is real file hygiene: literal CJK regex range characters in .mjs scanner/test files cause git/file to classify them poorly for review. Authorizes exactly ONE corrective commit to add textContent literal scanning, regenerate the allowlist as needed, and replace literal CJK regex chars with ASCII \uXXXX escapes. Marker remains 3126b24. Post-fix Layer-B audit must cover 3126b24..<fix-head>. No push/merge/marker mutation via this override.
2026-06-13T18:13:23Z override consumed: BATCH-FAIL remediation, single-use override: Layer-B audit of 0019e8f..f1ca3ca returned BATCH-FAIL C0 H0 M0 L1. The only finding is real but Low: renderer/i18n/catalog.ts has a stale WI-i18n-1 header comment claiming no screen consumes the catalog and that it seeds only enum-label entries, which became false after WI-i18n-2 wired shell + matter list. Authorizes exactly ONE corrective commit to update that comment only. Marker remains 0019e8f. Post-fix Layer-B audit must cover 0019e8f..<fix-head>. No push/merge/marker mutation via this override.
2026-06-14T00:52:17Z override consumed: BATCH-FAIL remediation, single-use override: Layer-B audit of 0019e8f..0424c64 returned BATCH-FAIL C0 H0 M0 L1. The finding is real: renderer/i18n/labels.ts has a stale WI-i18n-1 header comment claiming the facade is UNWIRED and no screen imports it, which became false after WI-i18n-2 wired listMatters. A sibling stale header exists in renderer/i18n/t.ts with infra-only framing now that t() is consumed by shell/list paths. Authorizes exactly ONE corrective comment-only commit to sweep stale i18n module header claims in labels.ts and t.ts, and only if needed catalog.ts for consistency. Marker remains 0019e8f. Post-fix Layer-B audit must cover 0019e8f..<fix-head>. No push/merge/marker mutation via this override.
2026-06-14T01:56:21Z override consumed: BATCH-FAIL remediation, single-use override: Layer-B audit of 2b22ade..4b270de returned BATCH-FAIL C0 H0 M0 L1. The finding is real: comments in renderer/i18n/catalog.ts, renderer/i18n/labels.ts, and renderer/screens/viewMatter.ts contain migration-state-specific wording that became stale after WI-i18n-3 migrated matter detail. Authorizes exactly ONE corrective comment-only commit to make those comments migration-agnostic and accurate for current/future screen migrations. Marker remains 2b22ade. Post-fix Layer-B audit must cover 2b22ade..<fix-head>. No push/merge/marker mutation via this override.
2026-06-14T02:15:38Z override consumed: BATCH-FAIL remediation, single-use override: Layer-B audit of 2b22ade..3f7961b returned BATCH-FAIL C0 H0 M0 L2. The findings are real but title-only: two renderer-view-matter test titles still embed old English UI copy after WI-i18n-3 migrated matter-detail copy to zh-CN. Authorizes exactly ONE corrective test-title-only commit to make those titles copy-agnostic. Marker remains 2b22ade. Post-fix Layer-B audit must cover 2b22ade..<fix-head>. No push/merge/marker mutation via this override.
2026-06-14T03:53:27Z override consumed: WX0: land L1 reword of plan-wechat-mini-program-00.md (audit audit-mqd8pbzb-w4hros), then re-audit + closeout
...
2026-07-09T14:01:17Z override consumed: WI-BACKUP-HARDEN-11-FIX1 remediation, single-use override: Layer-B audit of 86dd59c..c234f30 returned BATCH-FAIL C0 H1 M2 (running-app override, fail-open detector, post-tar path leak). All fixed fail-closed (verify verify-mrdknpid-zbif3p ALL CLOSED); 835/835. Authorizes ONE corrective commit; marker stays 86dd59c; post-fix Layer-B audit must cover 86dd59c..<fix-head>; no push/merge/marker-mutation.
2026-07-10T00:16:33Z override consumed: WI-MIGRATION-COMPAT-FIX1 remediation, single-use override: Layer-B audit of a7977ce..9f5700f returned BATCH-FAIL C0 H0 M2 (missing temp-root guard; old store rewound not frozen-DDL). M1 fixed (assertSafeTempRoot); M2 strengthened (complete frozen v1-v8 DDL fixture + authentic ATTACH rows), residual old-payload fidelity escalated in deferred-audit-findings; verify verify-mre66wyl-yim2tx ALL CLOSED; persistence 589/273/288, desktop 836/836. Authorizes ONE corrective commit; marker stays a7977ce; post-fix Layer-B audit must cover a7977ce..<fix-head>; no push/merge/marker-mutation.
2026-07-10T01:11:56Z override consumed: WI-SERVICES-CI-DOC-FIX1 remediation, single-use override: Layer-B audit of 2063b0d..eefe945 returned BATCH-FAIL C0 H0 M1 (services-ci-gates.md overstated "required for merge" — repo has no enforceable branch protection). Fixed: reworded to required-by-policy/technically-advisory (do-not-merge-on-red), mirroring desktop-release-gates + the run-log branch-protection note; added a matching workflow header comment (no behavior change). Verify verify-mre8koyk-zfp4fb ALL CLOSED. Authorizes ONE corrective commit; marker stays 2063b0d; post-fix Layer-B audit must cover 2063b0d..<fix-head>; no push/merge/marker-mutation.
2026-07-16T13:11:34Z override consumed: Governance-deadlock override (NOT a bypass of any substantive finding): batch audit of 14f4e1a..1abe9dd (audit-mrm4xfit-r17lir) failed SOLELY because the committed WI-PTA-04b docket header retained a stale "NOT authorized for implementation" status contradicting its reviewed-READY final state. The normal commit guard prevents correcting the committed docket while the failed audit prevents advancing the batch marker — a governance deadlock. This override authorizes exactly ONE docs-only commit changing only the stale header/status text in dev-memo/plan-pretrial-trial-addon-01-pta04b.md. No product code, artifact integration, scope expansion, or unrelated documentation change is authorized.
2026-07-16T14:30:37Z override consumed: Governance-recording deadlock override (NOT a bypass of the batch finding): batch audit audit-mrnkq5on-z8xmyq of 131fc31..3c2f828 failed solely because WI-PTA-04b implementation audits audit-mrnjow40-93d3wi and audit-mrnk9vwr-sza21y were not preserved in a tracked repository artifact. The due-closeout commit guard prevents adding the required record while the failed audit prevents advancing the marker. This override authorizes exactly ONE docs-only commit adding the cc-suite audit record; no amendment of 3c2f828, product change, artifact change, scope expansion, or unrelated documentation is authorized.
2026-07-29T14:54:14Z override consumed: Interactive feature-branch planning fix to resolve audit-due circularity; no push.
2026-08-05T06:45:02Z override consumed: batch-281 L1 remediation, single-use override: batch audit of d4ebb01..2275551 (audit-msfpo5bg-62zd28) returned BATCH-FAIL C0 H0 M0 L1 — a stale comment header in casebox-ui.electron.test.mjs describing the audit-panel step removed in WI-2d. Comment-only fix, no behavior change. Authorizes ONE comment-only commit; marker stays d4ebb01; post-fix Layer-B audit must cover d4ebb01..<fix-head> and PASS before closeout; no push/merge/marker-mutation.
2026-08-05T06:59:56Z override consumed: batch-281 re-audit L1 remediation, single-use override: re-audit d4ebb01..d0569fe (audit-msfq3g3p) returned BATCH-FAIL C0 H0 M0 L1 — ui-strings-allowlist.json line-numbers went stale by +1 for 3 viewMatter.ts literals after the header-comment fix shifted them; allowlist regenerated (106 entries, lines 241/261/434), full desktop gate green (870/869/1, only the pre-existing env smoke:21). Authorizes ONE allowlist-only commit; marker stays d4ebb01; post-fix Layer-B audit must cover d4ebb01..<fix-head> and PASS before closeout; no push/merge/marker-mutation.
2026-08-09T11:49:48Z override consumed: BATCH-289 M1 single-use override: audit-mslfl953 returned BATCH-FAIL C0 H0 M1 — the fixture party-name allowlist skipped non-string display_name values, so a wrapped name bypassed it. Fixed in-tree; 47/47 gate tests green; live negative control exits 1; nothing weakened. Authorizes ONE remediation commit (check-no-real-data.mjs + its test only); marker stays f86c8e4; post-fix audit must cover f86c8e4..<fix-head> and PASS before closeout; no push/merge.
2026-08-10T02:55:58Z override consumed: BATCH-292 H1 remediation: the narrow remediation lane is structurally unreachable because AUTO_ADVANCE_MAX=BATCH_AUDIT_EVERY=3, so audit-due and breaker always co-trip. A valid remediation token was created and correctly preserved. Authorizes ONE commit of the already-ready BRCBW-12 write-guard fix (.claude/hooks/block-run-control-bash-write.sh + its test only); marker stays eb7a7f5; a follow-up audit over eb7a7f5..<head> must PASS before normal commits resume; no push/merge. Next commit after this fixes the lane so a valid token counts as human attendance for breaker purposes.
