...
- **Structural** — the v1 backing is `InMemoryCaseBoxPersistence`; data lives only in JS memory + dies on process exit. Nothing is persisted; there is no surface where real lawyer data could accidentally land.
